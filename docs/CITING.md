...
Replace `XXXXXXX` with the assigned Zenodo record ID after deposit.
...
```markdown
[AI Convention Lifecycle Corpus v2.0.0](https://doi.org/10.5281/zenodo.XXXXXXX)
```
...
After Zenodo registration, update `XXXXXXX` in this file, [`CITATION.cff`](../CITATION.cff), [`metadata/zenodo.json`](../metadata/zenodo.json), and [`README.md`](../README.md).
